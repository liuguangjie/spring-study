 ...
 * without forcing a single translator to understand every single possible
 * type of exception.
 * 
 * @author Rod Johnson
 * @since 2.0
...
public interface PersistenceExceptionTranslator {
	 ...
	 * @param ex a RuntimeException thrown. Return <code>null</code> if the exception
	 * should not be translated, as in this case it may result from user code
	 * rather than a persistence problem.
